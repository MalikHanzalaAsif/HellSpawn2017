                        ...
                        <div className="flex justify-center gap-2 mb-4 mt-2">
                            {itemColors.map((color, index) => (
                                ...
                                >
                                    ...
                                    {/* Color Circle */}
                                    <div
                                        className={`w-4 h-4 rounded-full cursor-pointer border-2 transition-all duration-300 ${selectedColor && selectedColor.name === color.name ? 'border-gray-800' : 'border-transparent'
                                            }`}
