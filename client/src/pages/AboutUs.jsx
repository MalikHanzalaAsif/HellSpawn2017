...
const AboutUs = () => {
   return (
      <section id='aboutUs' className='pt-32'>
         <h1 className='text-8xl text-red-500 text-center mt-2'>About <span className='bg-red-500 text-white'>Us</span></h1>
         <div id='aboutUsContent' className="flex justify-center items-center">
            <div className='m-4'>
               <h2 className='text-4xl mb-8 text-blue-500'>Our <span className='bg-blue-500 text-white'>Products</span> Quality</h2>
